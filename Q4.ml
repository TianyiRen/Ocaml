...
let firewall = 
  create_static
    <:netkat< if (ethType = 0x800 && ipProto = 0x06 && ip4Src = 10.0.0.1 && (ip4Dst = 10.0.0.2 || ip4Dst = 10.0.0.3) && tcpDstPort = 443) ||
		(ethType = 0x800 && ipProto = 0x06 && ip4Src = 10.0.0.2 && (ip4Dst = 10.0.0.1 || ip4Dst = 10.0.0.3) && tcpDstPort = 443) ||
		(ethType = 0x800 && ipProto = 0x06 && ip4Src = 10.0.0.3 && (ip4Dst = 10.0.0.1 || ip4Dst = 10.0.0.2) && tcpDstPort = 443) then drop
		else id>>
